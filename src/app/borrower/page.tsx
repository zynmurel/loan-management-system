...
import { LoanContext } from "./template";
...
const Loans = () => {
  ...
  const columns: ColumnsType<any> = [
    ...
    //   },
    // },
    activeTabKey1 === "active" || activeTabKey1 === "done"
      ? {
          title: "Loan Date Started",
          dataIndex: "startDate",
          render: (data) => {
    ...
    activeTabKey1 === "done"
      ? {
          ...
          render: (data) => {
            return (
              <button
                onClick={() => router.push(`/borrower/loanDetails/${data}`)}
        ...
        footer={[
          ...
          activeTabKey1 === "active" ? (
            <button
              ...
              onClick={() => {
                router.push(
                  `/borrower/loanDetails/${openModal.data.referenceNo}`,
                );
              }}
            >
              Proceed to Loan Details
